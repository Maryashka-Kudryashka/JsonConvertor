...
public class JSONApp {
    ...
    public static JsonObject sessionResult() {
        JsonObject jsonObject = new JsonObject(new JsonPair("name", new JsonString("Andrii")),
                ...
                new JsonPair("year", new JsonNumber(2)), new JsonPair("exams",
                new JsonArray(new JsonObject(new JsonPair("course", new JsonString("OOP")),
                        ...
                        new JsonBoolean(true))), new JsonObject(
                        new JsonPair("course", new JsonString("English")), new JsonPair("mark", new JsonNumber(5)),
                        new JsonPair("passed", new JsonBoolean(true))), new JsonObject(new JsonPair("course",
